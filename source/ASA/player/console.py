...
def console_ccc():
    ...
    while data == None:
        ...
        while not is_open():
            ...
            if not is_open():
                logs.logger.debug("console not open after tab, pressing esc then tab again")
        ...
        if is_open():
            ...
            time.sleep(0.4*settings.lag_offset) # slow to try and prevent opening clipboard to empty data
            try:
                win32clipboard.OpenClipboard()
