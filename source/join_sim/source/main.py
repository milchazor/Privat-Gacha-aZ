...
def is_menu():
    return recon_utils.check_template_no_bounds("escape",0.7) or recon_utils.check_template_no_bounds("escape_obscured",0.7) or recon_utils.check_template_no_bounds("connection_timeout",0.7)
